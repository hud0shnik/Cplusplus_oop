...
public:
    ...
    friend ostream& operator << (ostream& stream, Sportsman S) {
        stream << "Name: " << S.Name <<
            " Medals: " << S.Medals <<
            " LastName: " << S.LastName <<
            " Age " << S.Age <<
            " Sitizenship: " << S.Sitizenship <<
            " Sport: " << S.Sport;
        return stream;
    }
};
...
int main() {
    AVL_Tree < string, Sportsman > SportsmanTree;
    Sportsman s1;
    s1.Name = "Name1";
    Sportsman s2;
    s2.Name = "Name2";
    ...
    Sportsman s4;
    s4.Name = "Name4";
    SportsmanTree.Add(s1);
    SportsmanTree.Add(s2);
    SportsmanTree.Add(s3);
    SportsmanTree.Add(s4);
    SportsmanTree.PrintBackward();
    cout << endl << endl;
    SportsmanTree.RemoveByValue(s2);
    SportsmanTree.PrintBackward();
    SportsmanTree.PrintForward();
}