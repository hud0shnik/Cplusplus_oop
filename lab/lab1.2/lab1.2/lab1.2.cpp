...
public:
    ...
    sportsman() { Medals = 0; Age = 0; Name = ""; }

    sportsman(int medals, int age, string name)
    {
        Medals = medals; Age = age; Name = name;
    }
    ...
    friend ostream& operator << (ostream& ustream, const sportsman& obj);
};
...
ostream& operator << (ostream& ustream, const sportsman& obj)
{
