...
int main() {
  AVL_Tree < string, realestate > realestateTree;
  realestate s1;
  s1.Adress = "Adress1";
  realestate s2;
  s2.Adress = "Adress2";
  ...
  realestate s4;
  s4.Adress = "Adress4";
  realestateTree.Add(s1);
  realestateTree.Add(s2);
  realestateTree.Add(s3);
  realestateTree.Add(s4);
  realestateTree.PrintBackward();
  cout << endl << endl;
  realestateTree.RemoveByValue(s2);
  realestateTree.PrintBackward();
  realestateTree.PrintForward();
}